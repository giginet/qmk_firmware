...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_moonlander(
        ...
        CTL_T(KC_TAB), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_LANG1,    KC_LANG2,KC_H,    KC_J,    KC_K,    KC_L,    LT(MDIA, KC_SCLN), KC_QUOT,
        KC_LSFT,       KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                          KC_N,    KC_M,    KC_COMM, KC_DOT,  LCTL_T(KC_SLSH),   KC_RSFT,
        MO(MDIA),      KC_QUOT, KC_LCTL, KC_LALT, KC_LGUI,          KC_SPC,      KC_ENT,           KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, MO(SYMB),
                                                  KC_SPC,  KC_LGUI, KC_LGUI,     KC_ENT,  KC_TAB,  KC_ENT
    ),
    ...
    [SYMB] = LAYOUT_moonlander(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,           KC_TRNS, KC_LEFT, KC_DOWN, KC_UP,   KC_TRNS, KC_TRNS, KC_TRNS,
    ...
    [MDIA] = LAYOUT_moonlander(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_MS_U, KC_TRNS, KC_TRNS, RESET,             KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_MS_L, KC_MS_D, KC_MS_R, KC_TRNS, KC_TRNS,           KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                             KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
