...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_GRV,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_LBRC,                        KC_RBRC , KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_SLSH, \
    ...
    MO(RAISE), KC_LCTL, KC_LALT, KC_LGUI,             LOWER,   KC_SPC ,KC_LGUI,           KC_ENT,KC_RGUI , RAISE,            KC_RGUI, KC_RALT, KC_RCTL,   MO(LOWER)  \
  ),
